...
- If the question asks "which/what/who" about one item, return that item only, not the sentence around it. Shortest means no extra words around the answer; never cut words out of a printed name, title or phrase ("Republic of South Africa" stays whole, "Dr. or Mrs. William J. Darby" stays whole).
